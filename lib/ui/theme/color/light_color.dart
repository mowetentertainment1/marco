...
class TwitterColor {
  static Color bondiBlue = const Color.fromRGBO(0, 180, 117, 1.0);
  static Color cerulean = const Color.fromRGBO(0, 180, 117, 1.0);
  ...
  static Color dodgeBlue = const Color.fromRGBO(0, 180, 117, 1.0);
  static Color dodgeBlue_50 = const Color.fromRGBO(0, 180, 117, 1.0);
...
class AppColor {
  static const Color primary = Color(0xff00b475);
